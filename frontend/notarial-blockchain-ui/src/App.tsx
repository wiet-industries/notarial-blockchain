    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="d-flex justify-content-around w-50">
          <Button variant="contained" onClick={connect}>Connect to server</Button>
          <Button variant="contained" onClick={broadcast}>Send broadcast to server</Button>
          <Button variant="contained" onClick={disconnect}>Disconnect from server</Button>
        </div>
